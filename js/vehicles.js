const vehicleData = {
    "vehicles": [
        ...
        },
        {
            "type": "Rally",
            "manufacturer": "Audi",
            "model": "Sport Quattro S1 E2",
            "year": 1986,
            "discipline": "Group B(4WD)",
            "specs": {
                "power": 550,
                "transmission": "5 speed - manual",
                "weight": 1090,
        ...
        {
            "type": "Rallycross",
            "manufacturer": "Speedcar",
            "model": "Xtrem",
            "year": 2016,
            "discipline": "Crosskart",
            "specs": {
                "power": 150,
                "transmission": "6 speed - manual sequential",
                "weight": 312,
        ...
        },
        {
            "type": "Rallycross",
            "manufacturer": "Ford",
            "model": "Fiesta OMSE Supercar Lites",
            "year": 2015,
            "discipline": "RX2",
            "specs": {
                "power": 310,
        ...
        vehicleContainer.insertAdjacentHTML(
            ...
            `<ul id="${ id }" class="tile vehicle-tile">
                <li>
                    ...
                    <h1 class="tile-name vehicle-manufacturer">${ vehicle.manufacturer } |</h1>
                    <h2 class="tile-name vehicle-model">${ vehicle.model }</h2>
            ...
            <aside id="${ id }-modal" class="modal hide">
                <ul>
                    <li>
                        <img src="images/vehicles/${ img }.jpg" alt="" class="modal-img">
                        <h2 class="vehicle-modal-name">${ vehicle.manufacturer } |</h2>
                        <h3 class="vehicle-modal-name">${ vehicle.model }</h3>
